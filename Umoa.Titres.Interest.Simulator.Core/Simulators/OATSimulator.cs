...
public interface IOATSimulator
{
...
public class OATSimulator : IOATSimulator
{
    ...
    public OATSimulator(ICouponCouruSimulator couponCouruSimulator, IPrixSimulator prixSimulator, IRendementSimulator rendementSimulator, IAmortissementSimulator amortissementSimulator, ISimulatorCommonRoutines routines)
    {
