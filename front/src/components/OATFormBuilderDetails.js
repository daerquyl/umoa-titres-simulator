...
[
    ...
    { label: TranslationService.translate("mode_amortissement", lang), name: "modeAmortissement", value: formData.modeAmortissement, onChange: onFormChange, options: { getList: () => modeAmortissements, getValue: (ma) => ma.code, getLabel: ma => ma.label } },
    { label: TranslationService.translate("differe", lang), type: "number", step: "1", name: "differe", value: formData.differe, onChange: onFormChange, onBlur: triggerSubmit },
